      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            />
            {errors.name && <p className="text-sm text-[var(--destructive)]">{errors.name.message}</p>}
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            />
            {errors.message && <p className="text-sm text-[var(--destructive)]">{errors.message.message}</p>}
          </div>
        </CardContent>
        <CardFooter>
          <Button
