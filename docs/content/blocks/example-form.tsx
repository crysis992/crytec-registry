    ...
    <div className="space-y-10">
      <section>
        ...
        <p className="text-[var(--muted-foreground)] mb-4">
          Example Form is a full block: a complete, styled contact form built with
          React Hook Form + Zod and composed from the underlying UI components.
        </p>
      ...
      <section>
        ...
        <p className="text-[var(--muted-foreground)] mb-4">
          This block does not accept props.
        </p>
      ...
      <section>
        ...
        <SimpleCodeblock code={sourceCode} filename="example-form/page.tsx" language="tsx" />
      </section>
    </div>
  );
}
