    ...
    <div className="space-y-10">
      <section>
        ...
        <div className="space-y-3">
          ...
          <p className="text-[var(--muted-foreground)]">
            You provide a <code className="rounded bg-[var(--muted)] px-1.5 py-0.5 text-sm">data</code> array. Each item must have a unique{' '}
            <code className="rounded bg-[var(--muted)] px-1.5 py-0.5 text-sm">value</code>. Use{' '}
            <code className="rounded bg-[var(--muted)] px-1.5 py-0.5 text-sm">filename</code> for display, and optionally set{' '}
            <code className="rounded bg-[var(--muted)] px-1.5 py-0.5 text-sm">language</code> to control Shiki highlighting.
          </p>
        </div>
      ...
      <section>
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-[var(--muted-foreground)] mb-4">Display multiple files with tab navigation.</p>
            <PreviewTabs
              preview={
                <CodeBlock
                  data={multiFileCode}
            ...
            <PreviewTabs
              preview={
                ...
                >
                  ...
                  <CodeBlockFooter>TypeScript example showing a simple greeting</CodeBlockFooter>
                </CodeBlock>
              }
              codeBlock={
                <SimpleCodeblock
            ...
            <div className="space-y-3 text-[var(--muted-foreground)]">
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  ...
                  <code className="bg-[var(--muted)] px-1.5 py-0.5 rounded ml-1">CodeBlockSelect*</code> components render a dropdown
                  picker.
                </li>
                <li>
