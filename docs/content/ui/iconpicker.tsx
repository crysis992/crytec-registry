...
import {
  ...
  IconPickerContent,
  IconPickerPreview,
} from "@/registry/new-york/ui/custom/iconpicker";
      ...
      <section>
        ...
        <div className="space-y-3">
          <p className="text-[var(--muted-foreground)]">
            IconPicker is a compound component for selecting icons from the Lucide
            React icon library. It provides a searchable dialog interface with
            real-time preview and optimized rendering for large icon lists.
          </p>
          <p className="text-[var(--muted-foreground)]">
            The component uses a compound component pattern, allowing you to
            customize the trigger, content, and preview independently. It supports
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-[var(--muted-foreground)] mb-4">
              Control both the icon value and dialog open state for more
              advanced use cases.
            </p>
            <PreviewTabs
              preview={<ControlledDemo />}
              codeBlock={<SimpleCodeblock code={controlledCode} language="tsx" />}
            />
          </div>
          ...
          <div>
            ...
            <PreviewTabs
              preview={<ColoredDemo />}
              codeBlock={<SimpleCodeblock code={withColorCode} language="tsx" />}
            />
          </div>
          ...
          <div>
            ...
            <PreviewTabs
              ...
              codeBlock={<SimpleCodeblock code={customTriggerCode} language="tsx" />}
            />
          </div>
        </div>
      </section>
