      ...
      <section>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              This component is available in the registry, but documentation is still being written.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-[var(--muted-foreground)]">
              You can still install and use this component using the installation command below.
              Full documentation with examples and API reference will be available soon.
            </p>
          </CardContent>
        </Card>
      </section>
